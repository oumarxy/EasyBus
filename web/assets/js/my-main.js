$(document).ready(function () {
    ...
    $('#input-file').fileinput({
        initialPreview: [
            "<img src='assets/img/product-1.jpg' class='file-preview-image' alt='Listing 1' title='Listing 1'>",
            "<img src='assets/img/product-2.jpg' class='file-preview-image' alt='Listing 2' title='Listing 2'>"
        ],
